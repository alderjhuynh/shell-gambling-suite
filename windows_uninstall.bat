...
echo Removing PowerShell profile commands...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0windows_support\update_powershell_profile.ps1" remove "%INSTALL_BIN%"
